...
data_imdb = pd.read_csv(r"C:\Users\Pathakamuri\Downloads\sentiment_analysis (1)\sentiment_analysis\Datasets", sep="\t", header=None)
data_imdb.columns = ['text', 'sentiment']

# Dataset 2: Yelp Dataset
data_yelp = pd.read_csv(r"C:\Users\Pathakamuri\Downloads\sentiment_analysis (1)\sentiment_analysis\Datasets", sep="\t", header=None)
data_yelp.columns = ['text', 'sentiment']

# Dataset 3: Amazon Cells Dataset
data_amazon = pd.read_csv(r"C:\Users\Pathakamuri\Downloads\sentiment_analysis (1)\sentiment_analysis\Datasets", sep="\t", header=None)
